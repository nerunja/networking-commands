...
|---|---|---|
| TCP chat | ```bash nc -l 5000``` | ```bash nc <HOST_A_IP> 5000``` |
| UDP chat | ```bash nc -u -l 5000``` | ```bash nc -u <HOST_A_IP> 5000``` |
| Keep accepting sequential clients | ```bash nc -lk 5000``` | _same as above_ |
